...
public interface LimitOrderRepository{
	...
	public Order getOrderId(String orderType, String currencyBuyInput, String currencySellInput, int size, double preferredPrice, Timestamp submittedTime, String userId);
	Order LimitgetOrderId(String orderType, String currencyBuyInput, String currencySellInput, int size,
			double preferredprice, Timestamp submittedTime, String userId) throws EmptyResultDataAccessException;
}